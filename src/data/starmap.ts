/**
 * starmap.ts — Layout of the constellation star map (M2).
...
export const starmap: Record<string, ConLayout> = {
  ...
  skills: {
    cx: 1200, cy: 1525, depth: 0.8, reticleR: 124,
    stars: [
  ...
  awards: {
    cx: 2025, cy: 1170, depth: 0.88, reticleR: 132,
    stars: [
  ...
  education: {
    cx: 2240, cy: 720, depth: 0.7, reticleR: 78,
